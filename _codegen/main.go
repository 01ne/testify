...
var (
	pkg       = flag.String("assert-path", "github.com/01ne/testify/assert", "Path to the assert package")
...
var headerTemplate = `// Code generated with github.com/01ne/testify/_codegen; DO NOT EDIT.
